...
const Cart = () => {
  const { data, isSuccess, isFetching } = useGetCartItemsQuery();
  ...
  return (
    <div className="d-flex flex-column ms-3 ps-sm-5 pe-sm-5 mt-4  flex-lg-row  ">
      ...
      {isSuccess && !isCartEmpty && (
        <div className="p-sm-3 ms-2 mt-5  w-lg-30 d-flex">
